...
const SystemConsole: React.FC<SystemConsoleProps> = ({ theme }) => {
    ...
    return (
        <div className={`fixed bottom-0 left-0 w-full h-8 sm:h-6 bg-black/10 backdrop-blur-sm flex items-center px-4 font-mono text-[9px] ${theme.mutedText} z-[70] transition-colors duration-700 pb-[env(safe-area-inset-bottom)]`}>
